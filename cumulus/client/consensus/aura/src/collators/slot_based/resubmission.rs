...
use cumulus_primitives_core::{
	...
	CumulusDigestItem, RelayBlockIdentifier, SchedulingInfoPayload, SignedSchedulingInfo,
};
...
///
/// The scheduling proof's `internal_scheduling_parent_header` is the current slot's relay parent,
/// so the para slot derived from its BABE slot equals the slot the claim was obtained for —
/// meaning the slot claim's author is the verifier-eligible signer.
///
